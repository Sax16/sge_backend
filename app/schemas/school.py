...
class SchoolBase(BaseModel):
    company_name: str = Field(..., description="Commercial name of the school", alias="companyName")
    business_name: str = Field(..., description="Legal business name of the institution", alias="businessName")
    management: str = Field(..., description="Name of the management or administrative unit")
    address: str = Field(..., description="Physical address of the school")
    email: EmailStr = Field(..., description="Institutional contact email")
    phone_number: str = Field(..., description="Institutional contact phone number", alias="phoneNumber")
    logo_path: str | None = Field(None, description="File path or URL to the school's logo", alias="logoPath")
    ruc: str = Field(..., description="Tax identification number (RUC)")
