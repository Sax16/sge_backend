...
class SchoolBase(BaseModel):
    ...
    management: str = Field(..., min_length=2, max_length=50, strip_whitespace=True, description="Name of the management or administrative unit")
    ...
    phone_number: str = Field(..., pattern=r"^\+?[\d\s\-]{7,15}$", description="Institutional contact phone number", alias="phoneNumber")
    ...
    ugel: str | None = Field(None, min_length=2, max_length=50, strip_whitespace=True, description="Local Education Management Unit (UGEL)")
...
class SchoolUpdate(SchoolBase):
    company_name: str | None = Field(None, min_length=2, max_length=255, strip_whitespace=True, description="Commercial name of the school", alias="companyName")
    business_name: str | None = Field(None, min_length=2, max_length=255, strip_whitespace=True, description="Legal business name of the institution", alias="businessName")
    management: str | None = Field(None, min_length=2, max_length=50, strip_whitespace=True, description="Name of the management or administrative unit")
    address: str | None = Field(None, min_length=2, max_length=150, strip_whitespace=True, description="Physical address of the school")
    email: EmailStr | None = Field(None, max_length=50, description="Institutional contact email")
    phone_number: str | None = Field(None, pattern=r"^\+?[\d\s\-]{7,15}$", description="Institutional contact phone number", alias="phoneNumber")
    logo_path: str | None = Field(None, max_length=255, description="File path or URL to the school's logo", alias="logoPath")
    ruc: str | None = Field(None, pattern=r"^(10|20)\d{9}$", description="Tax identification number (RUC)")
    dre: str | None = Field(None, min_length=2, max_length=50, strip_whitespace=True, description="Regional Education Directorate (DRE)")
    ugel: str | None = Field(None, min_length=2, max_length=50, strip_whitespace=True, description="Local Education Management Unit (UGEL)")
    headmaster_id: int | None = Field(None, gt=0, description="ID of the headmaster (Employee)", alias="headmasterId")
    deputy_director_id: int | None = Field(None, gt=0, description="ID of the deputy director (Employee)", alias="deputyDirectorId")
